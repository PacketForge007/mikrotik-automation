...
def load_script_to_router():
    try:
        ...
        cmd2 = f'system script add dont-require-permissions=no name=BackupMail owner=Girish policy=ftp,reboot,read,write,policy,test,password,sniff,sensitive,romon source="{script1}\\r\\ \\n{script2}\\r\\ \\n{script3}\\r\\ \\n{script4}\\r\\ \\n{script5}\\r\\ \\n{script6}\\r\\ \\n{script7}"'
        cmd3 = '/tool e-mail set server=mail.gtpl.net from=backup.epcrouter@gtpl.net password=BAckUP#EPC#Router#062024 port=587 tls=yes user=backup.epcrouter'
        cmd4 = '/ip dns set servers=8.8.8.8,8.8.4.4,2001:4860:4860::8888,2001:4860:4860::8844'
        cmd5 = '/system clock manual set time-zone=+05:30'
        cmd6 = '/system ntp client set enabled=yes servers=27.116.54.34'
